...
return [
    ...
    */
    ...
    'ascii' => 'Поле :attribute должно содержать только однобайтовые буквенно-цифровые символы и пробелы.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Данное поле :attribute появилось в утечке данных. Пожалуйста, выберите другое поле :attribute.',
    ],
